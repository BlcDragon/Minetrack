  ...
  initServerStatus (latestPing) {
    ...
    serverElement.innerHTML = `<div class="column column-favicon">
      ...
      <div class="column column-status">
        ...
        <span class="server-label" id="player-count_${this.serverId}">Игроков: <span class="server-value" id="player-count-value_${this.serverId}"></span></span>
        <span class="server-label" id="peak_${this.serverId}">Суточный максимум: <span class="server-value" id="peak-value_${this.serverId}">-</span></span>
        <span class="server-label" id="record_${this.serverId}">Рекорд: <span class="server-value" id="record-value_${this.serverId}">-</span></span>
